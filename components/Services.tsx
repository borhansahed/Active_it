    ...
    return (
        ...
        <div className='lg:mt-40 text-center'>
         ...
         <div className="flex justify-center items-center gap-x-14 mt-20">
           <div className="w-96 hover:shadow-xl  group p-6  rounded-md border hover:opacity-50 border-gray-300">
           ...
           <div className="w-96  hover:shadow-lg  group p-6 rounded-md border border-gray-300 hover:opacity-50">
