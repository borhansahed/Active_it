...
const Services = () => {
    return (
        ...
        <div className='lg:mt-40 text-center'>
         ...
         <div className="flex justify-center items-center gap-x-14 mt-20">
           <div className="w-96 hover:shadow-xl  group p-6  rounded-md border border-gray-300">
            <Image className=" group-hover:animate-pulse " src={logo} width={74} height={74} alt={'web&mobile design'}/>
            <h3 className="text-xl lg:mt-3 mb-3 font-bold text-white group-hover:opacity-50">Web & Mobile Design</h3>
            <p className="w-3/4 mx-auto group-hover:opacity-50">
            We craft stunning and amazing web UI, using a well drrafted UX to fit your product.
            </p>
           </div>
           <div className="w-96  hover:shadow-lg  group p-6 rounded-md border border-gray-300">
           ...
           <div className="w-96 hover:shadow-lg  group p-6 rounded-md border border-gray-300">
           <Image className="group-hover:animate-spin " src={logo2}  width={74} height={74} alt={'web development'}/>
