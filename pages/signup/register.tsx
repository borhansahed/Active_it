...
const register = () => {
    ...
    <input  className="p-2 w-80 text-black outline-gray-200 rounded-md" type="text" placeholder="Name" name="email" id="" required />
    ...
    <input className="p-2 w-80 text-black outline-gray-200 rounded-md" type="text" placeholder="Mobile Number" name="name" id="" required />
